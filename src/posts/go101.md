...
func main(){
    f("hello")
    go f("nav")
    go f("anirudhrowjeeisateddybear")
...
Fort advanced readers, the race condition problem we discusses earlier has been fixed using channels, ones intrested can see it's code ![here]()
