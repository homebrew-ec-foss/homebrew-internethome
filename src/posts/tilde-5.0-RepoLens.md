...
*Authors:* [Anish Arvind Koikude](https://github.com/Anish-CodeDev), [Prajwal MM](https://github.com/dotpmm), [Ishaan Padashetty](https://github.com/ishaanpadashetty), [Harsh Pandya](https://github.com/Seaweed-Boi)
...
The final piece ties the graph, the summaries, and the search index together into a conversational agent. When a user asks a question about the project — "how does authentication work here?" — the agent retrieves the most relevant nodes via RAG, then generates an answer grounded in those specific nodes. Every claim in the answer is tied back to a citation: the exact file, function, or class it came from, so the explanation is verifiable rat    her than a plausible-sounding guess.
